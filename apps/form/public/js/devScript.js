...
function setErrorInput(input) {
  ...
  if (input.dataset.selectize) {
    const selectizeInput =
      input.parentElement.querySelector(".selectize-input");
...
function getSelectedQuestAnswers() {
  ...
  questBlock.each(function (i, item) {
    ...
    if (
      !questData.hasOwnProperty("answers") &&
      !questData.hasOwnProperty("otherText")
    )
      return false;
...
function sendVoteProcess(form) {
  ...
  runSendVoteTry(
    ...
    function () {
      msgBlock
        .text("Произошла ошибка, пожалуйста попробуйте отправить еще раз")
        .addClass("fail");
    },
  );
}
...
function initPlantingFormSelectize(form) {
  ...
  if (locationSelect.length) {
    locationSelect.selectize({
      ...
      dropdownParent: "body",
      onFocus: function () {
        unsetErrorInput(locationSelect);
      },
    });
  }
  ...
  if (settlementSelect.length) {
    settlementSelect.selectize({
      ...
      onChange: function (id, title) {},
      onFocus: function () {
        unsetErrorInput(settlementSelect);
      },
    });
  }
  ...
  if (treeAmountSelect.length) {
    treeAmountSelect.selectize({
      ...
      dropdownParent: "body",
      onFocus: function () {
        unsetErrorInput(treeAmountSelect);
      },
    });
  }
  ...
  if (seedlingPriceSelect.length) {
    seedlingPriceSelect.selectize({
      ...
      onFocus: function () {
        unsetErrorInput(seedlingPriceSelect);
      },
    });
  }
}
