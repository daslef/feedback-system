        ...
        projectsData.forEach(function (item, i) {
          ...
          const feature = {
            ...
            properties: {
              ...
              balloonContentBody: `<ul class="projects-map-item-info">
...
function filterProjects() {
  ...
  const filterItemsChecked = document.querySelectorAll(
    '.filter-action[data-type="status"] input:checked ~ span',
  );

  for (const element of filterItemsChecked) {
    statusFilterOptions.push(
      `properties.typeStatus == "${element.textContent}"`,
    );
  }
  ...
  const yearItemsChecked = document.querySelectorAll(
    '.filter-action[data-type="year"] input:checked ~ span',
  );
  ...
  const segmentItemsChecked = document.querySelectorAll(
    '.filter-action[data-type="segment"] input:checked ~ span',
  );

  for (const element of segmentItemsChecked) {
    segmentFilterOptions.push(
      `properties.typeSegment == "${element.textContent}"`,
    );
  }
  ...
  const regionItemsChecked = document.querySelectorAll(
    '.filter-action[data-type="region"] input:checked ~ span',
  );

  for (const element of regionItemsChecked) {
    regionFilterOptions.push(
      `properties.typeRegion == "${element.textContent}"`,
    );
  }
